...
<Box width={1/2} style={{margin:'auto'}}>
  <UnorderedList>
    <ListItem><Text>Modularization - break up the pieces! use anything independently! automate integration!</Text></ListItem>
    <ListItem><Text>API stabilization - make everything predictable and extensible!</Text></ListItem>
    <ListItem><Text>community systems - help everyone work together!</Text></ListItem>
  </UnorderedList>
</Box>
